    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Remove inventory from warehouse</p>
        </div>
      </div>
            ...
            <div className="space-y-2">
              ...
              <Select>
                ...
                <SelectContent className="bg-popover">
                  ...
                  <SelectItem value="sample">Free Sample</SelectItem>
                  <SelectItem value="return">Return to Dealer</SelectItem>
                </SelectContent>
              </Select>
            </div>
            <div className="space-y-2">
