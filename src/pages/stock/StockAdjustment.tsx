...
const StockAdjustment = () => {
  ...
  const [items, setItems] = useState([{ product: "", prevStock: 45, newStock: "", reason: "" }]);

  const addItem = () => {
    setItems([...items, { product: "", prevStock: 0, newStock: "", reason: "" }]);
  };
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Fix stock mismatches</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle>Products to Adjust</CardTitle>
            ...
            {items.map((item, index) => (
              <div key={index} className="flex gap-4 items-end">
                ...
                <div className="w-28 space-y-2">
                  <Label>Current</Label>
                  <Input type="number" value={item.prevStock} disabled className="bg-muted" />
                </div>
                <div className="w-28 space-y-2">
      ...
      <Card>
        ...
        <CardContent>
          <Textarea placeholder="Enter detailed notes about this adjustment..." rows={3} />
        </CardContent>
      </Card>
