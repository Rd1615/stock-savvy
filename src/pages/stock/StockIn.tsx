...
const StockIn = () => {
  ...
  const [items, setItems] = useState([{ product: "", qty: "", notes: "" }]);

  const addItem = () => {
    setItems([...items, { product: "", qty: "", notes: "" }]);
  };
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Add inventory to warehouse</p>
        </div>
      </div>
            ...
            <div className="space-y-2">
              ...
              <Select>
                ...
                <SelectContent className="bg-popover">
                  ...
                  <SelectItem value="return">Return from Client</SelectItem>
