...
const CreatePurchase = () => {
  ...
  const gstTotal = 21600;
  const grandTotal = 141600;
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Add a new purchase from dealer</p>
          </div>
        </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select>
                    ...
                    <SelectContent className="bg-popover">
                      ...
                      <SelectItem value="prime">Prime Wholesale</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <div className="space-y-2">
                  <Label>Invoice Number</Label>
                  <Input value="PO-2024-0090" disabled className="bg-muted" />
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
